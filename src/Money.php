 ...
 * @license   MIT License
 *
 * @package   Uniondrug\Money
 */

namespace Uniondrug\Money;
...
class Money
{
    ...
    /**
     * @param \Uniondrug\Money\Money $money
     *
     * @return string
     */
    ...
    /**
     * 从一个数字构造一个货币对象，默认是人民币。
     *
     * @param        $amount
     * @param string $currency
     *
     * @return \Uniondrug\Money\Money
     */
    ...
    /**
     * 跟另外一个金额比较，0表示相等，1表示大于该金额，-1标识小于该金额，该比较不区分货币类型
     *
